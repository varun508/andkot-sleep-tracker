...
fun formatNights(nights: List<SleepNight>, resources: Resources): Spanned {
    ...
    sb.apply {
        ...
        nights.forEach {
            ...
            append("\t${convertLongToDateString(it.startTimeInMilli)}<br>")
            if (it.endTimeMilli != it.startTimeInMilli) {
                ...
                // Hours
                append("\t ${it.endTimeMilli.minus(it.startTimeInMilli) / 1000 / 60 / 60}:")
                // Minutes
                append("${it.endTimeMilli.minus(it.startTimeInMilli) / 1000 / 60}:")
                // Seconds
                append("${it.endTimeMilli.minus(it.startTimeInMilli) / 1000}<br><br>")
            }
        }
    }
